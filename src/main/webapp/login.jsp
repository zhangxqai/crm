...
<script type="text/javascript" src="jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
	...
	<script>
		...
		function login(){
			...
			//如果走到这里就说明账号和密码都有了，之后就走后台验证账号密码
			//使用ajax请求，验证
			$.ajax({
...
<body>
	...
	<div style="position: absolute; top: 120px; right: 100px;width:450px;height:400px;border:1px solid #ded5d5">
