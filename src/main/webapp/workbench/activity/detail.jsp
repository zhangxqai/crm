...
<script type="text/javascript">
				...
				success:function (data){
					...
					* */
					...
					if(data.success){
						...
						//对(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editBy)进行更新
	...
	function editRemark(id){
		...
		//在打开modal前需要获取文本框中的内容，
		 //$("#noteContent").val($("#e'+id+'"));
