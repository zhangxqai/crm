		...
		$("#convertBtn").click(function (){
			...
			*/
			if($("#isCreateTransaction").prop("checked")){
				...
				/*window.location.href = "workbench/clue/convert.do?clueId=&money=xxx&";*/
				////以.上传递参数的方式很麻烦，而且表单一旦扩充，挂载的参数有可能超出浏览器地址栏的上限.
				//我们想到使用提交交易表单的形式来发出本次的传统请求
				//提交表单的参数不用我们手动去挂载(表单中写name属性)，提交表单可以提交post请求
